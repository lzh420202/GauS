...
class RotatedRTMDetHead(RTMDetHead):
    ...
    def _bbox_post_process(self,
        ...
        if with_nms and results.bboxes.numel() > 0:
            ...
            # else:
            #     # synth_bboxes, synth_scores, synth_labels = synth_rotated(bboxes, results.scores,
            #     #                                                          results.labels, cfg.nms.iou_threshold,
            #     #                                                          cfg.max_per_img, synth_cfg=synth_cfg)
            #     det_bboxes, det_scores, det_labels = postprocess_rotated(bboxes, results.scores,
            #                                                              results.labels, cfg.nms.iou_threshold,
            #                                                              cfg.max_per_img, synth_cfg=synth_cfg)
            #
            #     results = InstanceData()
